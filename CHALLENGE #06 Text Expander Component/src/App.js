...
export default function App() {
  ...
  //   message: ProbTypes.number,
  //   collapseButtonText: ProbTypes.string,
  //   expandButtonText: ProbTypes.string,
  //   collapsedNumWords: ProbTypes.number,
  //   buttonColor: ProbTypes.string,
  //   expand: ProbTypes.boolean,
  ...
  function TextExpander({
    ...
    const displayText = isExpanded
      ? message
      : message.split(" ").slice(0, collapsedNumWords).join(" ") + "...";
  ...
  return (
    <div>
      <TextExpander message={msg1} key={Math.random()} />
      <TextExpander
